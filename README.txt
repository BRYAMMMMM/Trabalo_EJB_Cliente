...
a persistence unit "clienteePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "clientee/pom.xml":
...
artifact ("clientee.war") is already built. You can build
